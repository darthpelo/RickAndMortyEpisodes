...
enum LocalizedString {
    ...
    static func errorFormat(_ message: String) -> String {
        String(format: NSLocalizedString("error_format", comment: "Error message format"), message)
    }

    static func characterIdFormat(_ id: Int) -> String {
        String(format: NSLocalizedString("character_id_format", comment: "Character ID format"), id)
    }

    static func statusFormat(_ status: String) -> String {
        String(format: NSLocalizedString("status_format", comment: "Status format"), status)
    }

    static func speciesFormat(_ species: String) -> String {
        String(format: NSLocalizedString("species_format", comment: "Species format"), species)
    }

    static func originFormat(_ origin: String) -> String {
        String(format: NSLocalizedString("origin_format", comment: "Origin format"), origin)
    }

    static func episodeCountFormat(_ count: Int) -> String {
        String(format: NSLocalizedString("episode_count_format", comment: "Episode count format"), count)
    }

    static func exportedToFormat(_ filename: String) -> String {
        String(format: NSLocalizedString("exported_to_format", comment: "Exported to format"), filename)
    }
